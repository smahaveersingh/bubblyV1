            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <Image
                                source={icons.whiskey}
                                style={{
                                    height: 30,
                                    width: 30
                                }}
                            />
                            <Text style={{ color: COLORS.darkGray2, ...FONTS.body4 }}>{foodItem?.type} </Text>
                        </View>
                                ...
                                return (
                                    <TextButton
                                        ...
                                        buttonContainerStyle={{
                                            ...
                                            borderWidth: 1,
                                            borderRadius: SIZES.radius,
                                            borderColor: selectedSize == item.id ? COLORS.primary : COLORS.black,
                                            backgroundColor: selectedSize == item.id ? COLORS.primary : null
                                        }}
                                        label={foodItem.type == "whiskey" ? item.label : item.blabel}
                                        labelStyle={{
                                            color: selectedSize == item.id ? COLORS.white : COLORS.black,
                                            ...FONTS.body5
                                        }}
    ...
    function renderRestaurant() {
        return (
            ...
            >
                ...
                >
                    <Text style={{ ...FONTS.h3 }}>Bubbly</Text>
